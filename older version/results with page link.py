...
def create_columns():
    ...
    sheet_obj.cell(row=leetcode_id_cell_position[0], column=col_to_fill_solved).fill = PatternFill(start_color=yellow,
                                                                                                   end_color=yellow,
                                                                                                   fill_type="solid")
    sheet_obj.cell(row=leetcode_id_cell_position[0], column=col_to_fill_solved+1).fill = PatternFill(start_color=yellow,
                                                                                                   end_color=yellow,
                                                                                                   fill_type="solid")
    ...
    sheet_obj.cell(row=leetcode_id_cell_position[0], column=col_to_fill_solved+1).value = 'Page Link'
    ...
    sheet_obj.cell(row=leetcode_id_cell_position[0], column=col_to_fill_solved+1).border = thin_border
...
for path in path_list:
    ...
    for sheet_name in wb_obj.sheetnames:
        ...
        for row_val in range(leetcode_id_row_start_position, max_row + 1):
            ...
            page_link_cell = sheet_obj.cell(row=row_val, column=col_to_fill_solved+1)
            # default red for all
