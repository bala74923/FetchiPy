...
CONTEST_NAME = "biweekly contest 88"
...
for path in path_list:
    ...
    for sheet_name in wb_obj.sheetnames:
        ...
        for row_val in range(leetcode_id_row_start_position, max_row + 1):
            ...
            # curr-name is the user id (leet code id)
    ...
    wb_obj.save(
        output_path + '\\' + year_workbook_name + '.xlsx')  # should be saved because there are multiple workbook objects
